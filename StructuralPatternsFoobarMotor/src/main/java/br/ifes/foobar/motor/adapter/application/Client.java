 ...
 */
package br.ifes.foobar.motor.adapter.application;


import java.util.ArrayList;
import java.util.List;

import br.ifes.foobar.motor.adapter.SuperGreenEngine;
import br.ifes.foobar.motor.adapter.SuperGreenEngineAdapter;
import br.ifes.foobar.motor.model.Engine;
